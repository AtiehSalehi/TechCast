...
# Aufgabe Atieh Salehi video web app

The process of this project was in two and a half hours.
- one hour to learn the basics of Symfony and work with Symfony.
- one hour to install and process the document.
- Half an hour to design the system, then on the GitHub.
- To access the application start the server on the commandline, then find
- The application with the address http://localhost:8000
   - symfony server:start
- install "npm", "yarn"
- The work process is in the form of Symfony start module installation, after which the relevant "public/videofiles" is taken from this link and placed in the design of the home page.
- Thank you for giving me the opportunity to learn Symfony.
